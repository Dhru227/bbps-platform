...
export default function SegmentJourneyView({
  advisoryPlan,
  onboardingHref,
  ...
  const segmentLabel = advisoryPlan?.segment_label || advisoryPlan?.segment || "Guided Journey";
        ...
        <div style={{ marginTop: 10, display: "flex", flexWrap: "wrap", gap: 6 }}>
          {Object.entries(summary)
            ...
            .map(([key, value]) => {
              ...
              return <Pill key={key} text={`${label}: ${value}`} color="#3730A3" bg={accentBg} />;
            })}
        </div>
      )}
